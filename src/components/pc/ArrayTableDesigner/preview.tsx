...
import { ArrayTableLocales } from './locales'
import { createEnsureTypeItemsNode, findNodeByComponentPath, hasNodeByComponentPath, queryNodesByComponentPath } from '../../../plugin-sdk/funcs'
import { useDropTemplate } from '@designable/formily-antd/lib/hooks/useDropTemplate'
import { LoadTemplate } from '@designable/formily-antd/lib/common/LoadTemplate'
import { createArrayBehavior } from '../ArrayBaseDesigner'
...
ArrayTableDesigner.Behavior = createBehavior(createArrayBehavior('ArrayTable', ArrayTableSchema, ArrayTableLocales), {
