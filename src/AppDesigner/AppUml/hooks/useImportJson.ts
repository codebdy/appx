...
export function useImportJson(appId: string) {
  ...
  }, [backupSnapshot, classes, packages, setClasses, setRelations, setDiagrams, setCodes, setX6Nodes, setX6Edges, setPackages]);
